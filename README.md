...
- **Courage stories** — four-day modules built on a single heroic account (The Furnace, The Giant, The Den, The Storm, The Unseen Army). Each walks the same four beats — the fear, the choice, the outcome, what you carry forward — and ends every day with one concrete exercise. Scripture in these tracks is public domain (World English Bible, lightly modernized).
