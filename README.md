...
- **Spanish landing page** — `/es` mirrors the root page in Spanish, with its own fear index at `/es/fears`, its own screenshots captured from the app running in Spanish, and a language link in the nav and footer of both. It says plainly that the app's *interface* is still partly English while the content — all 108 days, the prayers and the scripture — is fully translated.
